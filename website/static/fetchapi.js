...
export function printCards(from, searchId) {
  ...
  $(".buy_button").click(async function () {
    ...
    if (uid == null) {
      ...
      var myModal = new bootstrap.Modal(
        document.getElementById("prompt_quantity")
      );
      myModal.show();
      document
        .getElementById("prompt_buy")
        .addEventListener("click", function () {
          ...
          if (qty == "0" || qty == "") {
            ...
            const temp = async () => {
              var price = await getprice(stockid);
              updat(stockid, qty, price);
            };
  ...
  $(".sell_button").click(function () {
    ...
    if (uid == null) {
      ...
      var stockid = this.id;
      var myModal = new bootstrap.Modal(
        document.getElementById("prompt_quantity2")
      );
      myModal.show();
      document
        .getElementById("prompt_sell")
        .addEventListener("click", function () {
  ...
  $(".stocksName").click(function () {
    ...
    document.getElementsByClassName("chartButtonsWrapper")[0].style.display =
      "inline";
  ...
  document
    .getElementsByClassName("closeMobileView")[0]
    .addEventListener("click", function () {
      document.getElementsByClassName("chartButtonsWrapper")[0].style.display =
        "none";
    });
  ...
  document
    .getElementsByClassName("fa-maximize")[0]
    .addEventListener("click", function () {
      document.getElementsByClassName("back_colour-Market")[0].style.display =
        "none";
      document.getElementsByClassName("fa-minimize")[0].style.display =
        "inline";
      document.getElementsByClassName("fa-maximize")[0].style.display = "none";
      document
        .getElementsByClassName("chartButtonsWrapper")[0]
        .classList.add("fullScreenChart");
    });

  document
    .getElementsByClassName("fa-minimize")[0]
    .addEventListener("click", function () {
      document.getElementsByClassName("back_colour-Market")[0].style.display =
        "inline";
      document.getElementsByClassName("fa-minimize")[0].style.display = "none";
      document.getElementsByClassName("fa-maximize")[0].style.display =
        "inline";
      document
        .getElementsByClassName("chartButtonsWrapper")[0]
        .classList.remove("fullScreenChart");
    });
}
getStockDetails();
